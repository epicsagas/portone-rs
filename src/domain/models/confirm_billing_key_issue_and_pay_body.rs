...
/// ConfirmBillingKeyIssueAndPayBody : 빌링키 발급 및 초회 결제 승인 입력 정보
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfirmBillingKeyIssueAndPayBody {
...
impl ConfirmBillingKeyIssueAndPayBody {
    /// 빌링키 발급 및 초회 결제 승인 입력 정보
    pub fn new(billing_issue_token: String) -> ConfirmBillingKeyIssueAndPayBody {
